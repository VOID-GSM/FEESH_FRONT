...
import { setTokenExpirationTimer } from "../api/axios";
...
function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // JWT의 exp를 기준으로 자동 로그아웃 타이머 설정
      setTokenExpirationTimer(response.accessToken);
    ...
    >
      ...
      >
        ...
        <div
          ...
          "
        >
          <p className="text-gray-500 mb-4">아직 회원이 아니신가요?</p>
