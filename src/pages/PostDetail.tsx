...
function PostDetail() {
  ...
  const handleDelete = () => {
    ...
    if (confirmDelete) {
      const updatedPosts = posts.filter((item) => item.id !== Number(id));
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-10">
      <button
        ...
        className="flex items-center gap-2 text-gray-600 hover:text-blue-700 mb-8"
      >
      ...
      <article className="bg-white rounded-2xl shadow-sm border p-8">
        ...
        <div className="w-full h-[360px] rounded-xl bg-gray-200 flex items-center justify-center mb-8">
        ...
        <section className="mt-10">
          ...
          <div className="bg-white rounded-2xl border p-5">
            <textarea
              ...
              className="w-full h-28 border rounded-lg p-4 resize-none"
            />
